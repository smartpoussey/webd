...
<body>
    <div class="container">
        <div class="form-box">
            <a href="./login-main.html"><img src="../images/logo/head_icon.png" alt="logo" height="70px" style="padding-bottom: 15px;"></a>
            ...
            <form action="./signup.php" method="post">
                <div class="input-group">
                    ...
                    <p>Forgot password? <a href="./forgot.html">Click here!</a><br><br><br></p>
                </div>
                <div class="btn-field">
                    <button type="submit" value="submit" name="save" id="signupBtn">Sign up</button>
